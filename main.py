...
for s in suits:
    for r in ranks:
        deck.append(Card(s,r))#create a new card from the __str__ method
#Print the cards to see them

for c in deck:
    print(c)#c is a card in the deck, each time this loop repeates it will call the __str__ method from the card class
